...
SPEED = 5
SCORE = 0
pygame.mixer.music.load('C:/images/background.wav')
...
background = pygame.image.load("C:/images/AnimatedStreet.png")
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        ...
        pygame.mixer.music.load('C:/images/crash.wav')
    ...
    if pygame.sprite.spritecollideany(P1, coins):
        pygame.mixer.Sound('C:/images/coinss.mp3').play()
        SCORE += 1
        C.move()
